  ...
  render(){
    ...
    return(
      <div>
         ...
         <div className="flx1">
      <div className="flx2">
      {/* <Paper elevation = {3} className={this.regstyles.roundtry} variant = "elevation" theme={theme}> */}
          ...
          <div className="flx4">
            <div>
              ...
              {/*   <Typography variant="h6"  className={this.regstyles.typostyle}>Регистрация</Typography> */}
                ...
                {/* <p style = {{paddingTop: "5%"}} ><Button className={this.regstyles.buttonstyle}variant="outlined" color="primary">Подтвердить</Button></p> */}
              </form>
            </div>
            {/* <div>
